...
const ROUTES = [
  ...
  { path: '/creation-site-internet-restaurant', title: 'GND Consulting, Création de site internet pour restaurant', desc: "Site internet pour restaurant : design qui donne faim, zéro commission, trouvable sur Google et par les IA. Réservation et commande en direct, site 100 % propriétaire. Dès 800 €." },
