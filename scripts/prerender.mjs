...
const ROUTES = [
  ...
  { path: '/agence-automatisation-ia-paris', title: 'Agence automatisation IA à Paris, agents IA et workflows | GND Consulting', desc: "Studio hybride humain × IA à Paris. Agents IA, chatbots et automatisation de vos process connectés à vos outils. Diagnostic gratuit, devis sur-mesure, vos données restent à vous." },
];
