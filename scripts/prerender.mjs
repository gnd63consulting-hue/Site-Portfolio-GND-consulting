...
const ROUTES = [
  ...
  { path: '/services', title: 'GND Consulting, Services — Quatre branches, une équipe', desc: "Sites vitrines & SEO, branding & identité visuelle, production audiovisuelle, automatisation & IA : quatre expertises intégrées, un seul interlocuteur, des engagements tenus." },
