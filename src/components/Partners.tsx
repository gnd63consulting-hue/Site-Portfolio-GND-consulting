...
export function Partners() {
  ...
  return (
    <section id="partners" className="py-32 px-6 lg:px-12 max-w-[1400px] mx-auto relative overflow-hidden">
              ...
              <div className="p-12 flex flex-col justify-center">
                ...
                <div className="relative mb-8">
                  <div className={`${currentPartner.bgColor} rounded-3xl p-8 relative overflow-hidden`}>
                    ...
                    <Quote className="w-10 h-10 text-slate-500 mb-4 relative z-10" />
                ...
                <div className="flex gap-4">
                  ...
                  <button className="flex items-center gap-3 px-8 py-4 bg-white border-2 border-slate-200 text-slate-700 rounded-2xl font-semibold hover:bg-slate-50 hover:border-slate-300 transition-all duration-500 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500/50">
                ...
                {activeTab === 'noceum' ? (
                  ...
                  <div className="h-full min-h-[600px] rounded-r-[2.5rem] overflow-hidden bg-black relative">
                    ...
                    <div className="absolute top-6 right-6 z-20">
                      <button className="px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 hover:bg-white/20 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white/50">
                    ...
                    <div className="absolute bottom-6 right-6 z-20">
                      <button className="px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 hover:bg-white/20 transition-all duration-300 group focus:outline-none focus:ring-2 focus:ring-white/50">
