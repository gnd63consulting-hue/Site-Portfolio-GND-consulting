...
export function ServiceProductionAudiovisuelle() {
  ...
  return (
    <main id="main-content" className="min-h-screen bg-white text-[#1A1A1A] font-sans">
      ...
      {/* ================================================================
          SECTION 3 — INTRO / APPROCHE (image gauche + texte droite)
          ================================================================ */}
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 reveal">
            <div className="relative">
              ...
              {/* Badge flottant */}
              <div className="absolute -bottom-10 -right-10 w-48 h-48 bg-white p-4 rounded-full shadow-lg flex items-center justify-center z-10 hidden md:flex">
          ...
          <div className="lg:col-span-7 reveal">
            ...
            <div className="mt-12 flex flex-wrap gap-4">
              <div className="px-6 py-4 bg-white rounded-xl shadow-sm border border-gray-100">
                <h4 className="font-display font-bold text-2xl mb-1">Captation</h4>
                <p className="text-sm text-gray-500">4K / 8K Pro</p>
              </div>
              <div className="px-6 py-4 bg-white rounded-xl shadow-sm border border-gray-100">
                <h4 className="font-display font-bold text-2xl mb-1">Montage</h4>
                <p className="text-sm text-gray-500">Post-production</p>
              </div>
              <div className="px-6 py-4 bg-white rounded-xl shadow-sm border border-gray-100">
                <h4 className="font-display font-bold text-2xl mb-1">Livraison</h4>
                <p className="text-sm text-gray-500">Tous formats</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ================================================================
          SECTION 4 — 6 CARTES EXPERTISES
          ================================================================ */}
      <section className="py-32 px-6 lg:px-12 bg-white">
        <div className="max-w-[1400px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 reveal">
            <div>
              <span className="inline-block py-1 px-3 border border-gray-300 rounded-full text-xs font-bold uppercase tracking-widest text-gray-500 mb-6">
                Notre offre
              </span>
            ...
            {expertises.map((item, i) => (
              ...
              >
                <div className="relative z-10">
                  ...
                  <h3 className="font-display text-2xl font-bold mb-3 text-[#1A1A1A] group-hover:text-white transition-colors duration-500">
                    {item.title}
                  </h3>
                ...
                <div className="relative z-10 flex flex-col gap-3">
                  <span className="text-xs font-mono uppercase tracking-widest border-b border-white/30 pb-1 opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform translate-y-4 group-hover:translate-y-0 inline-block">
                    En savoir plus
                  </span>
                  <span className="inline-block text-xs px-3 py-1 rounded-full border border-gray-300 group-hover:border-white/30 text-gray-400 group-hover:text-gray-300 w-fit transition-colors duration-500">
                    {item.delay}
                  </span>
                </div>
                {/* Image de fond grayscale au hover */}
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center mb-20 reveal">
            ...
            <h2 className="font-display text-4xl md:text-6xl font-semibold">
              ...
              <span className="text-gray-400 italic font-light">ensemble.</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, i) => (
              <div
                key={step.num}
                className="bg-white border border-gray-100 rounded-2xl p-8 reveal"
                style={{ transitionDelay: `${i * 100}ms` }}
              >
                <span className="text-7xl font-display font-bold text-gray-100 block mb-4 leading-none select-none">
                  {step.num}
                </span>
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {pillars.map((pillar, i) => (
              <div
                key={pillar.num}
                className="group bg-gray-50 rounded-2xl p-8 transition-all duration-500 hover:bg-black hover:text-white reveal"
                style={{ transitionDelay: `${i * 100}ms` }}
              >
                ...
                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mb-6 text-[#1A1A1A] group-hover:bg-white/10 group-hover:text-white transition-all duration-500">
      ...
      <section className="py-32 px-6 lg:px-12 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-center text-gray-500 mt-12 reveal">
            Une autre question ?{' '}
            <a href="/#contact-form" className="text-[#1A1A1A] font-medium underline underline-offset-4 hover:no-underline">
              Contactez-nous
            </a>
          </p>
        </div>
      ...
      <section className="bg-black text-white py-24 px-6 lg:px-12 mt-16 rounded-t-3xl md:rounded-t-[3rem] mx-2 lg:mx-4">
        <div className="max-w-[1400px] mx-auto text-center reveal">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/#contact-form" className="inline-flex justify-center items-center px-8 py-4 bg-white text-black rounded-full font-medium hover:bg-gray-200 transition-colors">
              Demander un devis personnalisé
            </a>
            <a href="/#realisations" className="inline-flex justify-center items-center px-8 py-4 border border-white/30 rounded-full font-medium hover:bg-white/10 transition-colors">
