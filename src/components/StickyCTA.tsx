  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden pointer-events-none">
      <div className="max-w-screen-sm mx-auto px-3 pb-3 pointer-events-auto">
        <div className="rounded-2xl shadow-2xl border border-blue-200/60 backdrop-blur-md bg-[linear-gradient(135deg,rgba(255,255,255,0.95)_0%,rgba(240,249,255,0.95)_100%)]">
