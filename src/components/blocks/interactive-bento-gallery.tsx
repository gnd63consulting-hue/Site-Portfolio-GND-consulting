/* InteractiveBentoGallery — composant 21st.dev intégré VERBATIM.
 *
 * Adaptation Vite unique : strip `'use client'` directive (Next.js, incompat Vite).
 * Tout le reste = 100% verbatim — MediaItem video intersection observer, modal
 * draggable dock, bento grid spans, framer-motion stagger, drag reorder.
 */
...
const MediaItem = ({ item, className, onClick }: { item: MediaItemType, className?: string, onClick?: () => void }) => {
    ...
    return (
        <img
            ...
            // Bug fix : hardcoded `object-cover` retiré — bloquait `object-contain`
            // passé depuis la modal. Callers passent maintenant object-fit explicite
            // via className (object-cover sur grid cards, object-contain sur modal).
