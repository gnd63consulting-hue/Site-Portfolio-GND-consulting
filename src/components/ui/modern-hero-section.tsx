/* HeroCollage — composant 21st.dev intégré STRICTEMENT VERBATIM.
 *
 * Aucune modification vs source fournie par Roodny — pas d'aspect-ratio forcé,
 * pas de slots ajoutés, pas de tailles override. Photos overlap = design intentionnel
 * du composant (cluster cards qui se chevauchent). 7 slots fixed.
 */
