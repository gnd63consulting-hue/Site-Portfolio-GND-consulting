/* /agence-web-boulogne-billancourt — page locale (SEO transactionnel).
 * 1 page = 1 requête « agence web Boulogne-Billancourt » (anti-cannibalisation).
 * Même gabarit que la page Versailles (hero forme orange diagonale façon Perez +
 * commerçante détourée ; corps façon blog-details). Charte GND, zéro tiret
 * cadratin, prix publics uniquement, honnêteté (pas de bureau sur place).
 * Schemas : LocalBusiness + Service (areaServed Boulogne-Billancourt/92) via seo.ts,
 * FAQPage (FaqJsonLd) + BreadcrumbList.
 * Contenu rédigé via le parcours BotSEO (étude Max + voix GND), 14/07/26. */
...
const FAQ_ITEMS = [
  { q: 'Combien coûte un site internet à Boulogne-Billancourt ?', a: "Deux formules à prix fixe et public : 800 € HT pour un site vitrine complet, 1 500 € HT avec réservation ou prise de rendez-vous en ligne. Fermes, sans surprise en cours de projet, quand le marché du 92 se situe souvent entre 2 000 et 6 000 €." },
  { q: 'Intervenez-vous vraiment à Boulogne-Billancourt ?', a: "Oui. Studio basé à Paris, nous intervenons régulièrement à Boulogne-Billancourt et dans les Hauts-de-Seine. Nous n'avons pas de bureau sur place et préférons vous le dire clairement. Échanges à distance, déplacement possible si le projet le nécessite." },
  { q: 'Quels délais de livraison pour un site à Boulogne-Billancourt ?', a: "3 semaines en moyenne à compter de la validation du brief : maquette, développement, intégration, référencement local et mise en ligne. À anticiper : la fourniture de vos textes et photos." },
  ...
  { q: 'Proposez-vous la refonte d’un site internet existant à Boulogne-Billancourt ?', a: "Oui. Audit de l'existant, nouvelle structure, migration des contenus, optimisation du référencement et des performances. La refonte démarre à 800 € HT selon l'ampleur." },
  { q: 'Le référencement local (SEO) est-il inclus ?', a: "Oui, dans chaque création. Contenu localisé, technique propre, configuration de la fiche Google Business : votre site est conçu pour apparaître sur les recherches de vos clients à Boulogne-Billancourt et dans le 92." },
];
...
.vsl-h1{position:relative;font-family:var(--serif);font-weight:700;letter-spacing:-.02em;color:var(--choco);font-size:clamp(40px,6.6vw,84px);line-height:.98;}
...
export function BoulognePage() {
  return (
    <main id="main" className="vsl">
      <style>{PALETTE}</style>
      <FaqJsonLd id="boulogne" items={FAQ_ITEMS} />

      {/* HERO façon Perez : forme orange diagonale ancrée coin haut-droit */}
      <header className="vsl-hero">
        <div className="wrapx">
          <div className="vsl-col">
            <span className="vsl-eye">Sites web &amp; SEO · Boulogne-Billancourt (92)</span>
            <h1 className="vsl-h1">Agence web à <span className="circ">Boulogne</span>-Billancourt.</h1>
            <p className="vsl-sub">Création de site internet dans les Hauts-de-Seine, par un studio créatif hybride humain × IA.</p>
        ...
        <div className="vsl-fig" aria-hidden="true">
          ...
          <svg className="vsl-spin" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg">
            ...
            <g className="ring"><path id="bngcp" d="M60 60 m-44 0 a44 44 0 1 1 88 0 a44 44 0 1 1 -88 0" fill="none" />
              <text fill="#FDF6EE" fontFamily="ui-monospace,monospace" fontSize="11.5" letterSpacing="3.2"><textPath href="#bngcp">· DEVIS GRATUIT · SANS ENGAGEMENT </textPath></text></g>
      ...
      <div className="vsl-strip">
        <div className="grid">
          ...
          <div className="c"><div className="n">92</div><div className="l">Boulogne &amp; Hauts-de-Seine</div></div>
        </div>
      </div>
      ...
      <section className="vsl-band">
        <div className="read">
          ...
          <h2 className="arttitle">Créer votre site internet à Boulogne-Billancourt, sans devis surprise ni abonnement</h2>
        </div>
      </section>
      ...
      <section className="vsl-body">
        <div className="read">
          <p className="lede">Vous cherchez une agence web à Boulogne-Billancourt pour la création de votre site internet ? Commerçant, artisan, profession libérale, TPE ou jeune startup, GND est un studio créatif hybride basé à Paris qui intervient dans tout le 92. Prix publics, méthode transparente, et un site qui vous appartient dès la livraison.</p>

          <h2><span className="num">01</span>Pourquoi votre visibilité locale est un vrai enjeu à Boulogne-Billancourt</h2>
          <p>Aujourd'hui, une large part des recherches Google ont une intention locale. Quand un habitant de Boulogne tape « ostéopathe Boulogne-Billancourt » ou « restaurant Boulogne » sur son téléphone, il attend un résultat proche, crédible, dans les secondes qui suivent. Les entreprises visibles dans le haut des résultats locaux captent l'essentiel des appels et des visites.</p>
          <p>Boulogne-Billancourt est l'une des villes les plus denses de France, avec un tissu économique intense et une concurrence forte au mètre carré. Si votre site est absent, lent ou mal référencé, c'est un client qui choisit le concurrent à deux rues. Un site internet à Boulogne n'est plus un luxe : c'est le socle minimum pour exister au-delà du bouche-à-oreille.</p>

          <figure className="vsl-shot">
            <img src={RUE_IMG} alt="Boutiques et commerces d'une rue de Boulogne-Billancourt" loading="lazy" width={1600} height={893} />
            <figcaption>Boulogne-Billancourt et les Hauts-de-Seine : un tissu local dense de commerces, professions libérales et TPE qui se cherchent d'abord sur Google.</figcaption>
          </figure>

          <h2><span className="num">02</span>Une offre claire, des tarifs publics</h2>
          <p>Chez la plupart des agences web des Hauts-de-Seine, la réponse à « combien ça coûte » est « contactez-nous pour un devis ». Nous faisons l'inverse : <strong>les tarifs sont publics, ici, maintenant.</strong></p>
          ...
          <p>Question que beaucoup oublient avant de signer : à qui appartient le site une fois livré ? Chez nous, la réponse est contractuelle : <strong>le site est à vous dès la livraison.</strong> Accès à l'hébergement, au code, à l'administration, et à votre nom de domaine. Contrairement aux constructeurs par abonnement, vous pouvez confier la maintenance à qui vous voulez dans six mois. Aucune clause de rétention.</p>

          <h2><span className="num">04</span>Une agence web parisienne qui intervient à Boulogne-Billancourt</h2>
          <p><strong>Soyons honnêtes : nous n'avons pas de bureau à Boulogne-Billancourt.</strong> Vous ne verrez pas notre nom sur la Grand-Place. En revanche, nous intervenons régulièrement comme agence digitale et développeur web pour des clients à Boulogne-Billancourt, Issy-les-Moulineaux, Sèvres, Meudon et dans tout le 92. Les échanges se font en visio, email et messagerie ; un déplacement sur place s'organise si le projet le demande. Ce qui compte, c'est la qualité de la communication, la clarté du process et la solidité du résultat, et c'est là-dessus qu'on s'engage.</p>
          ...
          <h2><span className="num">06</span>Référencement local à Boulogne-Billancourt : votre site trouvé par vos clients</h2>
          <p>Le référencement (SEO) à Boulogne-Billancourt repose sur trois piliers synchronisés : le <strong>site</strong> (contenu localisé, technique propre), la <strong>fiche Google Business</strong> (catégories, photos, avis) et la <strong>réputation</strong> (avis, cohérence des informations). Nous travaillons les trois dans chaque création. Votre site n'est pas livré « beau mais invisible », il est conçu pour apparaître sur les recherches de vos clients dans le 92.</p>

          <figure className="vsl-shot">
            <img src={MOBILE_IMG} alt="Personne consultant un commerce de Boulogne-Billancourt sur son smartphone" loading="lazy" width={1600} height={900} />
          ...
          <ul className="ll">
            ...
            <li><strong>Artisans du 92 :</strong> formulaire, zone d'intervention, galerie de réalisations, pour capter les recherches d'urgence.</li>
            ...
            <li><strong>TPE, PME &amp; startups :</strong> site vitrine ou refonte, image soignée et crédible, pensés pour convertir.</li>
          </ul>

          <h2><span className="num">08</span>Pourquoi GND plutôt qu'une autre agence du 92</h2>
          <div className="vsl-scroll">
          ...
          <h2><span className="num">09</span>Vos questions sur la création de site à Boulogne-Billancourt</h2>
          {FAQ_ITEMS.map((f) => (
          ...
          <div className="vsl-pills">
            <span>Agence web Boulogne-Billancourt</span><span>Création site internet</span><span>SEO local</span><span>Hauts-de-Seine 92</span>
          </div>
        </div>
      </section>
      ...
      <LocalAreaLinks current="/agence-web-boulogne-billancourt" city="Boulogne-Billancourt" />

      <div className="vsl">
        <div className="vsl-final">
          <h2>Un projet de site à Boulogne-Billancourt ?</h2>
