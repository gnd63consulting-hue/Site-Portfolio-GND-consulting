/* /agence-web-creteil — page locale (SEO transactionnel).
 * 1 page = 1 requête « agence web Créteil » (anti-cannibalisation).
 * Même gabarit que Versailles/Boulogne/Nanterre. Charte GND, zéro tiret cadratin,
 * prix publics, honnêteté (pas de bureau sur place).
 * Schemas : LocalBusiness + Service (areaServed Créteil/94) via seo.ts,
...
const HERO_IMG = '/assets/creteil-hero-commercant.webp';
const RUE_IMG = '/assets/creteil-rue.webp';
const MOBILE_IMG = '/assets/creteil-mobile-seo.webp';

const FAQ_ITEMS = [
  { q: 'Combien coûte un site internet à Créteil ?', a: "Deux formules à prix fixe et public : 800 € HT pour un site vitrine complet, 1 500 € HT avec réservation ou prise de rendez-vous en ligne. Fermes, sans surprise en cours de projet, quand le marché du 94 se situe souvent entre 2 000 et 6 000 €." },
  { q: 'Intervenez-vous vraiment à Créteil ?', a: "Oui. Studio basé à Paris, nous intervenons régulièrement à Créteil et dans le Val-de-Marne. Nous n'avons pas de bureau sur place et préférons vous le dire clairement. Échanges à distance, déplacement possible si le projet le nécessite." },
  { q: 'Quels délais de livraison pour un site à Créteil ?', a: "3 semaines en moyenne à compter de la validation du brief : maquette, développement, intégration, référencement local et mise en ligne. À anticiper : la fourniture de vos textes et photos." },
  ...
  { q: 'Proposez-vous la refonte d’un site internet existant à Créteil ?', a: "Oui. Audit de l'existant, nouvelle structure, migration des contenus, optimisation du référencement et des performances. La refonte démarre à 800 € HT selon l'ampleur." },
  { q: 'Le référencement local (SEO) est-il inclus ?', a: "Oui, dans chaque création. Contenu localisé, technique propre, configuration de la fiche Google Business : votre site est conçu pour apparaître sur les recherches de vos clients à Créteil et dans le 94." },
];
...
export function CreteilPage() {
  return (
    <main id="main" className="vsl">
      <style>{PALETTE}</style>
      <FaqJsonLd id="creteil" items={FAQ_ITEMS} />

      <header className="vsl-hero">
        <div className="wrapx">
          <div className="vsl-col">
            <span className="vsl-eye">Sites web &amp; SEO · Créteil (94)</span>
            <h1 className="vsl-h1">Agence web à <span className="circ">Créteil</span>.</h1>
            <p className="vsl-sub">Création de site internet dans le Val-de-Marne, par un studio créatif hybride humain × IA.</p>
        ...
        <div className="vsl-fig" aria-hidden="true">
          <div className="vsl-blob">
            <span className="script">Créteil</span>
            <div className="vsl-blobin">
              <img className="person" src={HERO_IMG} alt="Commerçant accueillant dans sa boutique à Créteil" loading="eager" width={900} height={1200} />
            </div>
          </div>
          <svg className="vsl-spin" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg">
            ...
            <g className="ring"><path id="crecp" d="M60 60 m-44 0 a44 44 0 1 1 88 0 a44 44 0 1 1 -88 0" fill="none" />
              <text fill="#FDF6EE" fontFamily="ui-monospace,monospace" fontSize="11.5" letterSpacing="3.2"><textPath href="#crecp">· DEVIS GRATUIT · SANS ENGAGEMENT </textPath></text></g>
      ...
      <div className="vsl-strip">
        <div className="grid">
          ...
          <div className="c"><div className="n">94</div><div className="l">Créteil &amp; Val-de-Marne</div></div>
        </div>
      </div>
      ...
      <section className="vsl-band">
        <div className="read">
          ...
          <h2 className="arttitle">Créer votre site internet à Créteil, sans devis surprise ni abonnement</h2>
        </div>
      </section>

      <section className="vsl-body">
        <div className="read">
          <p className="lede">Vous cherchez une agence web à Créteil pour la création de votre site internet ? Commerçant, artisan, profession libérale, TPE ou PME, GND est un studio créatif hybride basé à Paris qui intervient dans tout le 94. Prix publics, méthode transparente, et un site qui vous appartient dès la livraison.</p>

          <h2><span className="num">01</span>Pourquoi votre visibilité locale est un vrai enjeu à Créteil</h2>
          <p>Aujourd'hui, une large part des recherches Google ont une intention locale. Quand un habitant de Créteil tape « coiffeur Créteil » ou « plombier Créteil » sur son téléphone, il attend un résultat proche, crédible, dans les secondes qui suivent. Les entreprises visibles dans le haut des résultats locaux captent l'essentiel des appels et des visites.</p>
          <p>Préfecture du Val-de-Marne, Créteil concentre un tissu vivant de commerces de proximité, d'artisans et de professions libérales, avec une vraie concurrence de quartier. Si votre site est absent, lent ou mal référencé, c'est un client qui choisit le concurrent à deux rues. Un site internet à Créteil n'est plus un luxe : c'est le socle minimum pour exister au-delà du bouche-à-oreille.</p>

          <figure className="vsl-shot">
            <img src={RUE_IMG} alt="Commerces et boutiques d'une rue de Créteil" loading="lazy" width={1600} height={893} />
            <figcaption>Créteil et le Val-de-Marne : un tissu local dense de commerces, artisans et professions libérales qui se cherchent d'abord sur Google.</figcaption>
          </figure>

          <h2><span className="num">02</span>Une offre claire, des tarifs publics</h2>
          <p>Chez la plupart des agences web du Val-de-Marne, la réponse à « combien ça coûte » est « contactez-nous pour un devis ». Nous faisons l'inverse : <strong>les tarifs sont publics, ici, maintenant.</strong></p>
          ...
          <h2><span className="num">04</span>Une agence web parisienne qui intervient à Créteil</h2>
          <p><strong>Soyons honnêtes : nous n'avons pas de bureau à Créteil.</strong> En revanche, nous intervenons régulièrement comme agence digitale et développeur web pour des clients à Créteil, Maisons-Alfort, Saint-Maur-des-Fossés, Alfortville et dans tout le 94. Les échanges se font en visio, email et messagerie ; un déplacement sur place s'organise si le projet le demande. Ce qui compte, c'est la qualité de la communication, la clarté du process et la solidité du résultat, et c'est là-dessus qu'on s'engage.</p>
          ...
          <h2><span className="num">06</span>Référencement local à Créteil : votre site trouvé par vos clients</h2>
          <p>Le référencement (SEO) à Créteil repose sur trois piliers synchronisés : le <strong>site</strong> (contenu localisé, technique propre), la <strong>fiche Google Business</strong> (catégories, photos, avis) et la <strong>réputation</strong> (avis, cohérence des informations). Nous travaillons les trois dans chaque création. Votre site n'est pas livré « beau mais invisible », il est conçu pour apparaître sur les recherches de vos clients dans le 94.</p>

          <figure className="vsl-shot">
            <img src={MOBILE_IMG} alt="Personne consultant un commerce de Créteil sur son smartphone" loading="lazy" width={1600} height={893} />
          ...
          <ul className="ll">
            ...
            <li><strong>Artisans du 94 :</strong> formulaire, zone d'intervention, galerie de réalisations, pour capter les recherches d'urgence.</li>
          ...
          <h2><span className="num">08</span>Pourquoi GND plutôt qu'une autre agence du 94</h2>
          <div className="vsl-scroll">
          ...
          <h2><span className="num">09</span>Vos questions sur la création de site à Créteil</h2>
          {FAQ_ITEMS.map((f) => (
          ...
          <div className="vsl-pills">
            <span>Agence web Créteil</span><span>Création site internet</span><span>SEO local</span><span>Val-de-Marne 94</span>
          </div>
        </div>
      </section>
      ...
      <LocalAreaLinks current="/agence-web-creteil" city="Créteil" />

      <div className="vsl">
        <div className="vsl-final">
          <h2>Un projet de site à Créteil ?</h2>
