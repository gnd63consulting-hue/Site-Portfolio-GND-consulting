/* /agence-web-montreuil — page locale (SEO transactionnel).
 * 1 page = 1 requête « agence web Montreuil » (anti-cannibalisation).
 * Même gabarit que Versailles/Boulogne/Nanterre/Créteil. Charte GND, zéro tiret
 * cadratin, prix publics, honnêteté (pas de bureau sur place).
 * Schemas : LocalBusiness + Service (areaServed Montreuil/93) via seo.ts,
...
const MOBILE_IMG = '/assets/montreuil-mobile-seo.webp';

const FAQ_ITEMS = [
  { q: 'Combien coûte un site internet à Montreuil ?', a: "Deux formules à prix fixe et public : 800 € HT pour un site vitrine complet, 1 500 € HT avec réservation ou prise de rendez-vous en ligne. Fermes, sans surprise en cours de projet, quand le marché du 93 se situe souvent entre 2 000 et 6 000 €." },
  { q: 'Intervenez-vous vraiment à Montreuil ?', a: "Oui. Studio basé à Paris, nous intervenons régulièrement à Montreuil et en Seine-Saint-Denis. Nous n'avons pas de bureau sur place et préférons vous le dire clairement. Échanges à distance, déplacement possible si le projet le nécessite." },
  { q: 'Quels délais de livraison pour un site à Montreuil ?', a: "3 semaines en moyenne à compter de la validation du brief : maquette, développement, intégration, référencement local et mise en ligne. À anticiper : la fourniture de vos textes et photos." },
  ...
  { q: 'Proposez-vous la refonte d’un site internet existant à Montreuil ?', a: "Oui. Audit de l'existant, nouvelle structure, migration des contenus, optimisation du référencement et des performances. La refonte démarre à 800 € HT selon l'ampleur." },
  { q: 'Le référencement local (SEO) est-il inclus ?', a: "Oui, dans chaque création. Contenu localisé, technique propre, configuration de la fiche Google Business : votre site est conçu pour apparaître sur les recherches de vos clients à Montreuil et dans le 93." },
];
...
export function MontreuilPage() {
  return (
    <main id="main" className="vsl">
      <style>{PALETTE}</style>
      <FaqJsonLd id="montreuil" items={FAQ_ITEMS} />

      <header className="vsl-hero">
        <div className="wrapx">
          <div className="vsl-col">
            <span className="vsl-eye">Sites web &amp; SEO · Montreuil (93)</span>
            <h1 className="vsl-h1">Agence web à <span className="circ">Montreuil</span>.</h1>
            <p className="vsl-sub">Création de site internet en Seine-Saint-Denis, par un studio créatif hybride humain × IA.</p>
        ...
        <div className="vsl-fig" aria-hidden="true">
          <div className="vsl-blob">
            <span className="script">Montreuil</span>
            <div className="vsl-blobin">
              <img className="person" src={HERO_IMG} alt="Artisane créative accueillante dans son atelier à Montreuil" loading="eager" width={900} height={1200} />
            </div>
          </div>
          <svg className="vsl-spin" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg">
            ...
            <g className="ring"><path id="mtlcp" d="M60 60 m-44 0 a44 44 0 1 1 88 0 a44 44 0 1 1 -88 0" fill="none" />
              <text fill="#FDF6EE" fontFamily="ui-monospace,monospace" fontSize="11.5" letterSpacing="3.2"><textPath href="#mtlcp">· DEVIS GRATUIT · SANS ENGAGEMENT </textPath></text></g>
      ...
      <div className="vsl-strip">
        <div className="grid">
          ...
          <div className="c"><div className="n">93</div><div className="l">Montreuil &amp; Seine-Saint-Denis</div></div>
        </div>
      </div>
      ...
      <section className="vsl-band">
        <div className="read">
          ...
          <h2 className="arttitle">Créer votre site internet à Montreuil, sans devis surprise ni abonnement</h2>
        </div>
      </section>

      <section className="vsl-body">
        <div className="read">
          <p className="lede">Vous cherchez une agence web à Montreuil pour la création de votre site internet ? Commerçant, artisan, créateur, profession libérale ou jeune structure, GND est un studio créatif hybride basé à Paris qui intervient dans tout le 93. Prix publics, méthode transparente, et un site qui vous appartient dès la livraison.</p>

          <h2><span className="num">01</span>Pourquoi votre visibilité locale est un vrai enjeu à Montreuil</h2>
          <p>Aujourd'hui, une large part des recherches Google ont une intention locale. Quand un habitant de Montreuil tape « céramiste Montreuil » ou « fleuriste Montreuil » sur son téléphone, il attend un résultat proche, crédible, dans les secondes qui suivent. Les entreprises visibles dans le haut des résultats locaux captent l'essentiel des appels et des visites.</p>
          <p>Ville créative et vivante de Seine-Saint-Denis, Montreuil concentre un tissu unique d'ateliers d'artisans, de créateurs, de commerces indépendants et de professions libérales. La concurrence est réelle, l'exigence esthétique aussi. Si votre site est absent, lent ou mal référencé, c'est un client qui choisit le concurrent à deux rues. Un site internet à Montreuil n'est plus un luxe : c'est le socle minimum pour exister au-delà du bouche-à-oreille.</p>

          <figure className="vsl-shot">
            <img src={RUE_IMG} alt="Boutiques et ateliers d'une rue créative de Montreuil" loading="lazy" width={1600} height={893} />
            <figcaption>Montreuil et la Seine-Saint-Denis : un tissu local créatif d'ateliers, commerces indépendants et professions libérales qui se cherchent d'abord sur Google.</figcaption>
          </figure>

          <h2><span className="num">02</span>Une offre claire, des tarifs publics</h2>
          <p>Chez la plupart des agences web de Seine-Saint-Denis, la réponse à « combien ça coûte » est « contactez-nous pour un devis ». Nous faisons l'inverse : <strong>les tarifs sont publics, ici, maintenant.</strong></p>
          ...
          <h2><span className="num">04</span>Une agence web parisienne qui intervient à Montreuil</h2>
          <p><strong>Soyons honnêtes : nous n'avons pas de bureau à Montreuil.</strong> En revanche, nous intervenons régulièrement comme agence digitale et développeur web pour des clients à Montreuil, Vincennes, Bagnolet, Fontenay-sous-Bois et dans tout le 93. Les échanges se font en visio, email et messagerie ; un déplacement sur place s'organise si le projet le demande. Ce qui compte, c'est la qualité de la communication, la clarté du process et la solidité du résultat, et c'est là-dessus qu'on s'engage.</p>
          ...
          <h2><span className="num">06</span>Référencement local à Montreuil : votre site trouvé par vos clients</h2>
          <p>Le référencement (SEO) à Montreuil repose sur trois piliers synchronisés : le <strong>site</strong> (contenu localisé, technique propre), la <strong>fiche Google Business</strong> (catégories, photos, avis) et la <strong>réputation</strong> (avis, cohérence des informations). Nous travaillons les trois dans chaque création. Votre site n'est pas livré « beau mais invisible », il est conçu pour apparaître sur les recherches de vos clients dans le 93.</p>

          <figure className="vsl-shot">
            <img src={MOBILE_IMG} alt="Personne consultant un atelier de Montreuil sur son smartphone" loading="lazy" width={1600} height={900} />
          ...
          <ul className="ll">
            <li><strong>Créateurs &amp; artisans d'art :</strong> sites-portfolios soignés qui mettent vos pièces en valeur, boutique en ligne possible.</li>
            <li><strong>Commerces de proximité :</strong> sites simples et rapides, horaires et actualités mis en avant.</li>
            ...
            <li><strong>TPE, associations &amp; jeunes structures :</strong> site vitrine ou refonte, image soignée et crédible, pensés pour convertir.</li>
          </ul>

          <h2><span className="num">08</span>Pourquoi GND plutôt qu'une autre agence du 93</h2>
          <div className="vsl-scroll">
          ...
          <h2><span className="num">09</span>Vos questions sur la création de site à Montreuil</h2>
          {FAQ_ITEMS.map((f) => (
          ...
          <div className="vsl-pills">
            <span>Agence web Montreuil</span><span>Création site internet</span><span>SEO local</span><span>Seine-Saint-Denis 93</span>
          </div>
        </div>
      </section>
      ...
      <div className="vsl">
        <div className="vsl-final">
          <h2>Un projet de site à Montreuil ?</h2>
