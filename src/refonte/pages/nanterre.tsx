/* /agence-web-nanterre — page locale (SEO transactionnel).
 * 1 page = 1 requête « agence web Nanterre » (anti-cannibalisation).
 * Même gabarit que Versailles/Boulogne (hero forme orange + personne détourée,
 * corps blog-details). Charte GND, zéro tiret cadratin, prix publics, honnêteté.
 * Schemas : LocalBusiness + Service (areaServed Nanterre/92) via seo.ts,
...
const HERO_IMG = '/assets/nanterre-hero-professionnelle.webp';
const RUE_IMG = '/assets/nanterre-rue.webp';
const MOBILE_IMG = '/assets/nanterre-mobile-seo.webp';

const FAQ_ITEMS = [
  { q: 'Combien coûte un site internet à Nanterre ?', a: "Deux formules à prix fixe et public : 800 € HT pour un site vitrine complet, 1 500 € HT avec réservation ou prise de rendez-vous en ligne. Fermes, sans surprise en cours de projet, quand le marché du 92 se situe souvent entre 2 000 et 6 000 €." },
  { q: 'Intervenez-vous vraiment à Nanterre ?', a: "Oui. Studio basé à Paris, nous intervenons régulièrement à Nanterre et dans les Hauts-de-Seine. Nous n'avons pas de bureau sur place et préférons vous le dire clairement. Échanges à distance, déplacement possible si le projet le nécessite." },
  { q: 'Quels délais de livraison pour un site à Nanterre ?', a: "3 semaines en moyenne à compter de la validation du brief : maquette, développement, intégration, référencement local et mise en ligne. À anticiper : la fourniture de vos textes et photos." },
  ...
  { q: 'Proposez-vous la refonte d’un site internet existant à Nanterre ?', a: "Oui. Audit de l'existant, nouvelle structure, migration des contenus, optimisation du référencement et des performances. La refonte démarre à 800 € HT selon l'ampleur." },
  { q: 'Le référencement local (SEO) est-il inclus ?', a: "Oui, dans chaque création. Contenu localisé, technique propre, configuration de la fiche Google Business : votre site est conçu pour apparaître sur les recherches de vos clients à Nanterre et dans le 92." },
];
...
export function NanterrePage() {
  return (
    <main id="main" className="vsl">
      <style>{PALETTE}</style>
      <FaqJsonLd id="nanterre" items={FAQ_ITEMS} />

      <header className="vsl-hero">
        <div className="wrapx">
          <div className="vsl-col">
            <span className="vsl-eye">Sites web &amp; SEO · Nanterre (92)</span>
            <h1 className="vsl-h1">Agence web à <span className="circ">Nanterre</span>.</h1>
        ...
        <div className="vsl-fig" aria-hidden="true">
          <div className="vsl-blob">
            <span className="script">Nanterre</span>
            <div className="vsl-blobin">
              <img className="person" src={HERO_IMG} alt="Professionnelle accueillante dans son bureau à Nanterre" loading="eager" width={900} height={1200} />
            </div>
          </div>
          <svg className="vsl-spin" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg">
            ...
            <g className="ring"><path id="nancp" d="M60 60 m-44 0 a44 44 0 1 1 88 0 a44 44 0 1 1 -88 0" fill="none" />
              <text fill="#FDF6EE" fontFamily="ui-monospace,monospace" fontSize="11.5" letterSpacing="3.2"><textPath href="#nancp">· DEVIS GRATUIT · SANS ENGAGEMENT </textPath></text></g>
      ...
      <div className="vsl-strip">
        <div className="grid">
          ...
          <div className="c"><div className="n">92</div><div className="l">Nanterre &amp; Hauts-de-Seine</div></div>
        </div>
      </div>
      ...
      <section className="vsl-band">
        <div className="read">
          ...
          <h2 className="arttitle">Créer votre site internet à Nanterre, sans devis surprise ni abonnement</h2>
        </div>
      </section>

      <section className="vsl-body">
        <div className="read">
          <p className="lede">Vous cherchez une agence web à Nanterre pour la création de votre site internet ? Commerçant, artisan, profession libérale, TPE ou PME, GND est un studio créatif hybride basé à Paris qui intervient dans tout le 92. Prix publics, méthode transparente, et un site qui vous appartient dès la livraison.</p>

          <h2><span className="num">01</span>Pourquoi votre visibilité locale est un vrai enjeu à Nanterre</h2>
          <p>Aujourd'hui, une large part des recherches Google ont une intention locale. Quand un habitant de Nanterre tape « avocat Nanterre » ou « garagiste Nanterre » sur son téléphone, il attend un résultat proche, crédible, dans les secondes qui suivent. Les entreprises visibles dans le haut des résultats locaux captent l'essentiel des appels et des visites.</p>
          <p>Préfecture des Hauts-de-Seine, voisine de La Défense, Nanterre mêle un tissu de professions libérales, de PME et de commerces de quartier, avec une concurrence sérieuse. Si votre site est absent, lent ou mal référencé, c'est un client qui choisit le concurrent à deux rues. Un site internet à Nanterre n'est plus un luxe : c'est le socle minimum pour exister au-delà du bouche-à-oreille.</p>

          <figure className="vsl-shot">
            <img src={RUE_IMG} alt="Commerces et boutiques d'une rue de Nanterre" loading="lazy" width={1600} height={893} />
            <figcaption>Nanterre et les Hauts-de-Seine : un tissu local dense de commerces, professions libérales et PME qui se cherchent d'abord sur Google.</figcaption>
          </figure>
          ...
          <h2><span className="num">04</span>Une agence web parisienne qui intervient à Nanterre</h2>
          <p><strong>Soyons honnêtes : nous n'avons pas de bureau à Nanterre.</strong> En revanche, nous intervenons régulièrement comme agence digitale et développeur web pour des clients à Nanterre, Rueil-Malmaison, Suresnes, Puteaux et dans tout le 92, La Défense comprise. Les échanges se font en visio, email et messagerie ; un déplacement sur place s'organise si le projet le demande. Ce qui compte, c'est la qualité de la communication, la clarté du process et la solidité du résultat, et c'est là-dessus qu'on s'engage.</p>
          ...
          <h2><span className="num">06</span>Référencement local à Nanterre : votre site trouvé par vos clients</h2>
          <p>Le référencement (SEO) à Nanterre repose sur trois piliers synchronisés : le <strong>site</strong> (contenu localisé, technique propre), la <strong>fiche Google Business</strong> (catégories, photos, avis) et la <strong>réputation</strong> (avis, cohérence des informations). Nous travaillons les trois dans chaque création. Votre site n'est pas livré « beau mais invisible », il est conçu pour apparaître sur les recherches de vos clients dans le 92.</p>

          <figure className="vsl-shot">
            <img src={MOBILE_IMG} alt="Personne consultant un professionnel de Nanterre sur son smartphone" loading="lazy" width={1600} height={900} />
          ...
          <ul className="ll">
            ...
            <li><strong>TPE, PME &amp; indépendants :</strong> site vitrine ou refonte, image soignée et crédible, pensés pour convertir.</li>
          </ul>
          ...
          <h2><span className="num">09</span>Vos questions sur la création de site à Nanterre</h2>
          {FAQ_ITEMS.map((f) => (
          ...
          <div className="vsl-pills">
            <span>Agence web Nanterre</span><span>Création site internet</span><span>SEO local</span><span>Hauts-de-Seine 92</span>
          </div>
        </div>
      </section>
      ...
      <LocalAreaLinks current="/agence-web-nanterre" city="Nanterre" />

      <div className="vsl">
        <div className="vsl-final">
          <h2>Un projet de site à Nanterre ?</h2>
