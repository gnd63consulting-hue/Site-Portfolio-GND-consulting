        ...
        <Container>
          <div className="grid lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8">
              ...
              <Faq q="Vous êtes seul ou une équipe ?" a="GND est une agence boutique : notre équipe vous écoute et pilote votre projet de bout en bout (briefing, design, relation client). L'IA accélère certaines productions (génération de maquettes, copy, photo si besoin). Vous gardez un suivi clair, sans intermédiaire."/>
